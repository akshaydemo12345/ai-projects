    ...
    document.addEventListener('submit', function(e) {
      if (e.target.tagName === 'FORM') {
        ...
        if (!isValid || isInEditor) {
          ...
          setTimeout(function() {
            e.target.innerHTML = '<div class="tpl-templates02-5" style="padding: 20px; text-align: center"><h3 style="margin: 0 0 10px 0; font-size: 20px;">Thank You!</h3><p style="margin: 0;">Your request has been submitted successfully.</p></div>';
          }, 1000);
        }
      }
    }, true);
