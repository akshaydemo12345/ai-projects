...
:root{
  --bg:#1a0f08; --cream:#f4ead5; --amber:PRIMARY_COLOR_PLACEHOLDER; --gold:SECONDARY_COLOR_PLACEHOLDER;
...
.logo small{color:var(--gold);margin-left:.25rem;font-size:.85rem}
...
.btn-amber:hover{background:var(--gold);transform:translateY(-2px);box-shadow:0 10px 30px rgba(217,119,6,.4)}
...
.kicker{font-size:.75rem;letter-spacing:.3em;color:var(--gold);font-weight:600;display:block;margin-bottom:1.5rem}
...
.hero-card{background:rgba(244,234,213,.97);color:var(--ink);padding:2rem;border-radius:8px;box-shadow:0 30px 80px rgba(0,0,0,.4);border-top:4px solid var(--amber)}
...
.feat span{font-family:var(--serif);font-size:2rem;color:var(--gold);font-weight:700;display:block;margin-bottom:.75rem}
...
.sec-head .kicker{color:var(--amber)}
...
.badge{display:inline-block;background:var(--ink);color:var(--gold);font-size:.65rem;letter-spacing:.2em;font-weight:700;padding:.4rem .75rem;border-radius:3px;margin-bottom:.85rem}
.exp h3{font-family:var(--serif);font-size:1.6rem;font-weight:700;margin-bottom:.25rem}
.meta{font-size:.85rem;color:var(--amber);font-weight:600;margin-bottom:.75rem;letter-spacing:.05em}
.exp-info p{color:PRIMARY_COLOR_PLACEHOLDER;font-size:.92rem;margin-bottom:1rem}
...
.testimonial cite{font-style:normal;font-size:.85rem;letter-spacing:.15em;color:var(--gold);font-weight:500}

.cta-final{background:linear-gradient(135deg,var(--amber),#b45309);color:#fff;padding:6rem 0;text-align:center}
...
.foot-grid h5{font-family:var(--serif);font-size:1rem;margin-bottom:1rem;color:var(--gold);font-weight:700}
...
.wildlife-text p{font-size:1.1rem;color:PRIMARY_COLOR_PLACEHOLDER;margin-bottom:2rem}
...
.wildlife-list li::before{content:"→";position:absolute;left:0;color:var(--amber);font-weight:700}
...
.wildlife-img-sub{position:absolute;bottom:0;right:0;width:55%}
...
.lodge-content p{color:PRIMARY_COLOR_PLACEHOLDER;line-height:1.7}
...
.newsletter{padding:7rem 0;background:var(--bg);color:var(--cream);border-top:1px solid rgba(244,234,213,.1)}
.newsletter .booking-intro h2{color:#fff}
.newsletter .booking-intro p{color:rgba(244,234,213,.7)}
.newsletter .booking-form{background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.1);backdrop-filter:blur(10px)}
.newsletter .booking-form label{color:var(--gold)}
.newsletter .booking-form input{background:rgba(26,15,8,.5);border-color:rgba(244,234,213,.2);color:#fff}
.newsletter .booking-form input:focus{border-color:var(--gold)}
...
.gallery-overlay span{color:var(--gold);font-size:.75rem;letter-spacing:.2em;font-weight:700;transform:translateY(10px);transition:transform .4s}
...
.impact-text h2{font-family:var(--serif);font-size:clamp(2rem,4vw,3.2rem);margin:1rem 0 2rem;line-height:1.1;color:#fff}
.impact-stats{display:grid;grid-template-columns:repeat(3,1fr);gap:2rem;margin-top:3rem}
.stat strong{display:block;font-size:2.5rem;font-family:var(--serif);color:var(--gold);margin-bottom:.25rem}
...
.newsletter .booking-form{background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.1);backdrop-filter:blur(20px);padding:3.5rem}
...
/* Booking form */
.booking{background:var(--cream);padding:7rem 0;border-top:1px solid #e8dfce}
.booking-wrap{display:grid;grid-template-columns:1fr 1.3fr;gap:4rem;align-items:start}
.booking-intro h2{font-family:var(--serif);font-size:clamp(2rem,4vw,3rem);font-weight:700;color:var(--ink);margin:1rem 0}
.booking-intro p{color:#5b5246;font-size:1.05rem;line-height:1.7}
.booking-form{background:#fff;padding:2.5rem;border:1px solid #e8dfce;box-shadow:0 20px 60px -30px rgba(0,0,0,.2)}
.booking-form .row{display:grid;grid-template-columns:1fr 1fr;gap:1.2rem;margin-bottom:1.2rem}
.booking-form label{display:block;font-size:.75rem;letter-spacing:.15em;text-transform:uppercase;color:var(--ink);font-weight:600;margin-bottom:.4rem}
.booking-form label.full{display:block;margin-bottom:1.5rem}
.booking-form input,.booking-form select,.booking-form textarea{width:100%;padding:.85rem 1rem;border:1px solid #d7cdb9;background:var(--cream);font-family:inherit;font-size:.95rem;color:var(--ink);margin-top:.4rem;transition:border .2s}
...
.booking-form .btn{width:100%;justify-content:center;display:inline-flex;align-items:center;border:none;cursor:pointer}
@media(max-width:860px){.booking-wrap{grid-template-columns:1fr;gap:2rem}.booking-form{padding:1.8rem}.booking-form .row{grid-template-columns:1fr}}
...
<header class="nav">
    <div class="container nav-inner">
      ...
      <a href="#" class="btn">Book Safari</a>
    </div>
  </header>
  ...
  <section class="hero">
    ...
    <div class="container hero-grid">
      <form class="booking-form"
        ...
        <button type="submit" class="btn btn-amber large">Send Inquiry →</button>
      </form>
      <div class="hero-text">
        ...
        <div class="cta-row">
          <a href="#" class="btn btn-amber">View Expeditions</a>
    ...
    <div class="container">
      <div class="wildlife-grid">
        <div class="wildlife-text">
          ...
          <a href="#booking" class="btn btn-amber">Learn More</a>
        </div>
  ...
  <section class="newsletter">
    <div class="container booking-wrap">
      <div class="booking-intro">
        ...
        <h2>The Wild Letter</h2>
        <p>Get exclusive safari tips, conservation news, and first access to our seasonal expeditions directly in your
          inbox.</p>
      </div>
      <form class="booking-form"
        onsubmit="event.preventDefault();alert('Subscribed! Welcome to the pack.');this.reset();">
        <div class="row">
          <label>First Name<input type="text" name="fname" required placeholder="Jane"></label>
          <label>Email Address<input type="email" name="email" required placeholder="jane@example.com"></label>
        </div>
        <button type="submit" class="btn btn-amber large">Join the Pride →</button>
      </form>
    </div>
  </section>
