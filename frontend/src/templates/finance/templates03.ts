...
<section class="why-choose">
  ...
  <div class="container why-inner">
    <div class="why-text animate-up">
      ...
      <p class="tpl-templates04-2" style="margin-bottom: 30px">We combine industry expertise with innovative technologies to deliver results that matter. Our commitment to excellence sets us apart from the competition.</p>
    ...
    document.addEventListener('submit', function(e) {
      if (e.target.tagName === 'FORM') {
        ...
        if (!isValid) {
          ...
          setTimeout(function() {
            e.target.innerHTML = '<div class="tpl-templates04-10" style="padding: 20px; text-align: center"><h3 style="margin: 0 0 10px 0; ">Thank You!</h3><p style="margin: 0;">Your request has been submitted successfully.</p></div>';
          }, 1000);
        }
      }
    }, true);
