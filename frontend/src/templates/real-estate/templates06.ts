...
@media (max-width: 768px) {
  .re06-services-grid, .re06-features-grid, .re06-faq-grid { grid-template-columns: 1fr !important; }
  .re06-hero-content, .re06-split-flex, .re06-feature { flex-direction: column !important; }
}
