    ...
    if (html && iframeRef.current) {
      ...
      if (doc) {
        ...
        doc.addEventListener('submit', (e) => {
          e.preventDefault();
          let existingModal = doc.getElementById('preview-mode-modal');
          if (existingModal) existingModal.remove();
          const modalHtml = '<div id="preview-mode-modal" style="position: fixed; top: 0; left: 0; right: 0; bottom: 0; z-index: 999999; display: flex; align-items: center; justify-content: center; background: rgba(15, 23, 42, 0.7); backdrop-filter: blur(8px); opacity: 0; animation: pModalFadeIn 0.3s forwards; font-family: system-ui, -apple-system, sans-serif;">' +
