  ...
  const handleCreate = () => {
    ...
    if (activeMethod === "template" && selectedTemplate) {
      ...
      switch (selectedTemplate) {
        case "saas-hero": enrichedContent = saasHeroHtml; enrichedStyles = saasHeroStyles; break;
        case "agency": enrichedContent = agencyHtml; enrichedStyles = agencyStyles; break;
        case "lead-gen": enrichedContent = leadGenHtml; enrichedStyles = leadGenStyles; break;
        case "real-estate": enrichedContent = realEstateHtml; enrichedStyles = realEstateStyles; break;
        default: enrichedContent = saasHeroHtml; enrichedStyles = saasHeroStyles;
      }
