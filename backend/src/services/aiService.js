...
const generateLandingPageContent = async (input) => {
  ...
  const userPromptPart2 = buildUserPromptPart2(
    input, recipe, sectionsPart2, fields, submitLabel, placement, sectionsPart1.length, formInHero, formInPart1
  );

  // ── PASS 2: remaining sections + form (if not already in hero) + footer + closing tags. Fresh full budget. ──
